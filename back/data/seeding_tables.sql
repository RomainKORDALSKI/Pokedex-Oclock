...
VALUES
    ('Team Rocket', 'La Team Rocket est une organisation criminelle qui s''est donné pour but la domination du monde par tous les moyens criminels possibles.'),
    ('Team Aqua', 'La Team Aqua est une organisation active dans la région de Hoenn.'),
    ('Team Galaxie', 'La Team Galaxie est une organisation active dans la région de Sinnoh.');
